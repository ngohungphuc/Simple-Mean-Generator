module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            //if any js file change in the folder 
            //will delete the .min.js and the create new file
            scripts: {
            ...
            //do not delete this line it's wont refresh browser when front end change
            server: {
                files: ['.rebooted'],
                options: {
                    livereload: true
        ...
        //delete older version to create new version
        clean: {
    ...
    //config another task that you want to run
